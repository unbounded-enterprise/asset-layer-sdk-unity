...
namespace AssetLayer.SDK.Core.Assets
{
    public class AssetsHandler : BaseHandler
    {
        ...
        public AssetsRawHandlers Raw = new AssetsRawHandlers {
            ...
            GetUserAssetIds = async (props, headers) => await _this.Request<GetAssetIdsResponse>("/asset/user" + AssetLayerUtils.PropsToQueryString(props, new AssetUserProps { idOnly = true }), "GET", null, headers),
            GetUserAssetCounts = async (props, headers) => await _this.Request<GetAssetCountsResponse>("/asset/user" + AssetLayerUtils.PropsToQueryString(props, new AssetUserProps { countsOnly = true }), "GET", null, headers),
